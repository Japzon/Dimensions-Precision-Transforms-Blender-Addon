...
def update_dim_is_flipped(self, context):
    """Callback for 'Flip Target Roles': Triggers a visual update."""
...
def register():
    ...
    bpy.types.Scene.lsd_dim_include_hooks = bpy.props.BoolProperty(
        name="Include Hooks",
        description="When removing dimensions, also bake and delete the associated parametric hooks",
        default=True
    )
