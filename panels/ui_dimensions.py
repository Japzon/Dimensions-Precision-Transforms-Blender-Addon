...
class LSD_PT_Dimensions_And_Precision_Transforms(bpy.types.Panel):
    bl_label = "Dimensions & Precision Transforms"
    bl_idname = "VIEW3D_PT_lsd_dimensions_precision_transforms"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'Dimensions & Precision Transforms'
    """
    ...
    def draw(self, context):
        ...
        box = layout.box(); is_expanded = True
